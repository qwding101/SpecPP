---
title: "Introduction to SpecPP"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to SpecPP}
...
Here we use the Lansing Woods dataset from `spatstat` package, which consists of the locations of six different types of trees.
